...
class WebProcessor:
    ...
    def scrap_oto(self, link):
        ...
        self.flat.advertiser = self.soup.find(attrs={"aria-label": "Typ ogłoszeniodawcy"})
        ...
        self.flat.other_info = self.soup.find(attrs={"aria-label": "Informacje dodatkowe"})
        ...
        self.flat.balcony = self.soup.find(attrs={"aria-label": "Balkon / ogród / taras"})
